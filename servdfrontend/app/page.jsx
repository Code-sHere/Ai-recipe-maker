        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            <div className="flex-1 text-center md:text-left">
              <Badge variant="outlline"
                className="border-2 border-orange-600 text-orange-700 bg-orange-100 text-sm font-bold mb-6 uppercase tracking-wide">
              ...
              <p className="textxl md:text-2xl text-stone-600 mb-10 max-w-lg md-mx-0 font-light">Snap a photo of yours fridge. We&apos;ll tell you what to cook. Save money, reduce waste, and eat better tonight.</p>
            ...
            <Card className={"relative aspect-square md:aspect-4/5 border-4 border-stone-900 bg-stone-200 overflow-hidden py-0"}>
              ...
              />
              <Card className="absolute bottom-8 left-8 right-8 bg-yellow-100 rounded-3xl backdrop-blur-sm border-2 border-stone-900 py-0"><CardContent className="p-4">
      ...
      <section className="py-12 border-y-2 border-stone-900 bg-stone-900">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center px-4">
          {SITE_STATS.map((stat, i) => {
            return (
              <div key={i}>
                <div className="text-4xl font-boldmb-1 text-stone-50">{stat.val}</div>
                <Badge
                  variant="secondary"
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-16">
            ...
            <p className="text-stone-600 text-xl font-light">
              Everything you need to cook the perfect meal, all in one place.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <CardContent className={"p-8"}>
                    <div className="flex justify-between itmes-start mb-6 ">
                      <div className="border-2 border-stone-200 bg-orange-50 p-3 group-hover:border-orange-600 group-hover:bg-ornage-100 transition-colors rounded-full">
                        <IconComponent className="w-6 h-6" />
                      </div>
                      <Badge
                        variant="secondary"
                        className="text-xs font-mono bg-stone-100 txt-stone-600 uppercase tracking-wide border-stone-200">
                        {feat.limit}
                      </Badge>
                    </div>
                    <h3 className="text-2xl font-bold mb-3">{feat.title}</h3>
                    <p className="text-stone-600 text-lg font-light">{feat.description}</p>
                  </CardContent>
                </Card>
              )
            })}
